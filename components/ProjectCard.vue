  ...
  <div class="hover:border-custom_green hover:bg-custom_gray hover:shadow-custom_darker_green border border-gray-100 shadow-md rounded-md p-4">
    <div class="flex flex-col space-y-4">
      ...
      <NuxtLink :to="`/projects/${ project.id}`"
        class="rounded-md bg-custom_green px-4 py-2 text-sm w-fit whitespace-nowrap font-medium text-custom_black hover:bg-custom_darker_green hover:text-white"
      >
        More information
      </NuxtLink>
    </div>
